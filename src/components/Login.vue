    ...
    <div class="d-flex text-center mt-md-5">
        <main class="form-signin">
            <form @submit="onSubmit">
                ...
                <small class="text-danger" v-if="invalid == 'no_email'">이메일이 존재하지 않습니다.</small>
                <input
                        type="email"
                        id="inputEmail"
                        class="form-control"
                        ...
                        v-model="email"
                />
                <small class="text-danger" v-if="invalid == 'wrong_password'">비밀번호가 틀렸습니다.</small>
                <input
                        type="password"
                        id="inputPassword"
                        class="form-control"
                ...
                <div v-if="!is_login_form">
                    <small class="text-danger" v-if="invalid == 'diff_passwords'">새로운 비밀번호가 다릅니다.</small>
                    <input
                            type="password"
